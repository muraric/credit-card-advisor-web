        ...
        <Layout>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    <h2 className="text-lg font-semibold text-gray-700 mb-3">💳 Manage Cards</h2>
                    ...
                    <button
                        onClick={saveProfile}
                        className="w-full mt-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold"
                    >
                        Save Cards
                    </button>
                </div>
